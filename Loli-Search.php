                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-mdb-toggle="collapse"
                            ...
                            <h5>Loli Search Nedir?</h5>
                        </button>
                    </h2>
                    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                        <div class="accordion-body">
                            Loli Search, Artado Software bünyesinde Reklamsız ve tamamen gizliği ön planda tutan Anime(Japon Çizgi Filmi) temalı aynı zamanda açık kaynak kodlu bir arama motorudur.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo">
                        <div class="accordion-body">
                            Loli Search'in diğer arama motorlarından farkı çerez kullanmamasıdır. hiçbir çereziniz kaydedilmez yanlızca Session dediğimiz
                    ...
                    <div class="card-body">
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            <div class="accordion-item">
                                ...
                                >
                                    <div class="accordion-body">
                                        Loli MyAccount sayesinde Loli ve Artado My Account'u kullanan 3.parti yazılımlara direkt kayıt olmadan giriş yapabiliceksiniz.  My Account'da hiç bir veriniz izinsiz bir şekilde hiç bir 3. parti servise veya kişiye verilmez. Kullanıcıların şifreleri, şifreleme algoritması ile şifrelenerek kaydedilir.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                >
                                    <div class="accordion-body">
                                        Loli Anime Kartları random olarak gösterilir. Her aramanızda yeni bir anime gösterir ek olarak eklenen animelere kendi sitenizden link koyabilir veya olmayan bir animeyi oluşturabilirsiniz.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">

...
if(isset($_POST['sikayet'])){
	...
	try{
		...
		if(!isset($veri_ekle)){
			echo '<div class="alert alert-danger">Sayın kullanıcımız, Anlaşılan bir hata ile baş başasınız lütfen Discord Sunucumuz üzerinden bize şikayetinizi bildiriniz. Teknik aksaklık için içtenlikle özür dileriz (HATA: Nova_Bots/sikayet.php, LİNE: 15-24)</div>';
		}else{
